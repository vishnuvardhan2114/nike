...
import { InsertVariant, productVariants } from './schema/variants';
...
import { productCollections } from './schema/collections';
import { insertGenderSchema } from './schema/filters/genders';
import { insertColorSchema } from './schema/filters/colors';
import { insertSizeSchema } from './schema/filters/sizes';
import { insertBrandSchema } from './schema/brands';
import { insertCategorySchema } from './schema/categories';
import { insertCollectionSchema } from './schema/collections';
import { insertProductSchema } from './schema/products';
import { insertVariantSchema } from './schema/variants';
import { InsertProductImage, insertProductImageSchema, productImages } from './schema/images';
import { InsertProduct} from './schema/products';

// Define types for the inferred select methods
